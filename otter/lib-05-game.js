...
//updated: 20.05.2022
//dodano: collidedPlatform polje kako bi se znalo koju platformu dira
...
class Sprite extends GameWorldObjectAnimator {
  constructor(x, y, w, h) {
    ...
    /** @type {String} string "top", "left", "right", "bottom" ili prazno ako ne dira platformu */
...
/**
 * Klasa: Box
 * - predstavlja nepomičan predmet (alternativna platforma)
 * - upodatePosition() je prazna
 */
